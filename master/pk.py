...
output_path      = '/project/projectdirs/desi/users/mjwilson/mockchallenge/master/'
...
r                    = FFTPower(mesh, mode='2d', dk=0.01, kmin=0.0, kmax=k_Nyquist, Nmu=120, los=[0,0,1], poles=poles)
Pkmu                 = r.power
rpoles               = r.poles
