...
class SubhaloModelFactory(ModelFactory):
    ...
    def _parse_constructor_kwargs(self, **kwargs):
        ...
        **kwargs : optional keyword arguments
        ...
        if 'baseline_model_instance' in kwargs:
            ...
            for key, value in list(input_model_dictionary.items()):
    ...
    def _enforce_component_model_format(self, candidate_model_dictionary):
        ...
        for feature_key, component_model in list(candidate_model_dictionary.items()):
    ...
    def set_inherited_methods(self):
        ...
        for feature, component_model in list(self.model_dictionary.items()):
    ...
    def set_model_redshift(self):
        ...
        if len(set(zlist)) == 0:
            ...
            for modelname, model in list(self.model_dictionary.items()):
    ...
    def build_init_param_dict(self):
        ...
        for feature, component_model in list(self.model_dictionary.items()):
            ...
            for key, value in list(component_model.param_dict.items()):
