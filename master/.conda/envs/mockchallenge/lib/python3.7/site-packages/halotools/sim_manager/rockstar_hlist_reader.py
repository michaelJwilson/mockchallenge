...
class RockstarHlistReader(TabularAsciiReader):
    ...
    def _write_metadata(self):
        ...
        for haloprop_key, cut_value in list(self.row_cut_min_dict.items()):
            attrname = haloprop_key + '_row_cut_min'
            f.attrs.create(attrname, cut_value)

        for haloprop_key, cut_value in list(self.row_cut_max_dict.items()):
            attrname = haloprop_key + '_row_cut_max'
            f.attrs.create(attrname, cut_value)

        for haloprop_key, cut_value in list(self.row_cut_eq_dict.items()):
            attrname = haloprop_key + '_row_cut_eq'
            f.attrs.create(attrname, cut_value)

        for haloprop_key, cut_value in list(self.row_cut_neq_dict.items()):
